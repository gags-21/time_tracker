...
class _EmailSignInFormState extends State<EmailSignInForm> {
  ...
  TextField _buildPasswordTextField() {
    bool showsErrorText = _submitted && !widget.passwordValidator.isValid(_password);
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        labelText: 'Password',
        errorText: showsErrorText ? widget.invalidPasswordErrorText : null,
      ),
